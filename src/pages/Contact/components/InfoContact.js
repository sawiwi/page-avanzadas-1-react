...
const InfoContact = () =>{
    ...
    return(
        <div className="bg-secondary bg-opacity-30 w-full xl:min-h-[40vh] 3xl:min-h-[80vh]">
            ...
            <div className="absolute left-[19rem]  xl:h-[82vh] 3xl:h-[80vh] inset-0 xl:w-[30%] 3xl:w-[34%] pl-4 xl:pl-14 3xl:pl-24 bg-secondary bg-opacity-50 ">
