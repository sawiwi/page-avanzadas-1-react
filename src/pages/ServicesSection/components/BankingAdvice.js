...
return(
    <div className="grid  grid-cols-1 xl:grid-cols-2 xl:m-2 mt-8">
        ...
        <div className="col-span-1">
            ...
            <div className="3xl:right-2 flex items-center w-[360px] 3xl:w-[720px] pl-2 h-[21rem]">
                <div className="absolute top-[48%]  3xl:top-0 3xl:right-0 flex flex-col mr-2   border-primary hover:backdrop-blur-sm duration-150 bg-secondary-grey/30 px-10">
