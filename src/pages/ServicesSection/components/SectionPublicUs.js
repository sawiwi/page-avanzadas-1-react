    ...
    return(
        <div className="grid  grid-cols-1 xl:grid-cols-2 m-2 mt-14 3xl:mt-24">
            <div className="col-span-1">
                <div className="bg-opacity-30 h-[60vh] 3xl:h-[100%] w-[21rem] ">
                    <img src={imgWithUs} alt="" className="h-full w-full object-cover"/>
                </div>
                <div className="absolute left-2 3xl:left-[8px] top-0 inset-0 flex items-center justify-center xl:justify-start w-[335px] 3xl:w-[720px] h-[22.5rem] pl-3 hover:backdrop-blur-sm duration-150 bg-secondary-grey/10">
