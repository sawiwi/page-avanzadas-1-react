    ...
    return(
        <div className="grid  grid-cols-1 xl:grid-cols-2 m-2 mt-8 3xl:mt-24">
            <div className="col-span-1">
                <img src={imgWithUs} alt="" className="h-full w-full object-cover bg-primary-700/30"/>
                <div className="absolute 3xl:left-[8px] top-0 inset-0 flex items-center justify-start 3xl:w-[720px] pl-2 bg-secondary-grey bg-opacity-30">
