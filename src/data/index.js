...
const {HiOutlineCurrencyDollar, HiOutlineBriefcase, HiOutlinePresentationChartBar , MdAddHomeWork  }= iconsList;
...
export const UserExperience = [
  ...
  },
  {
    ...
    last_name:'Vargas',
    type:'Asociada Unne ',
    comment:'Hace aproximadamente un año que contraté UNNE y, además de lo completo del servicio, lo cual no he visto en otro proveedor, sin duda, la atención directa y diligente de los ejecutivos, es lo mejor.',
  },
  {
    id:3,
    avatar:'https://res.cloudinary.com/dvdb33uyj/image/upload/v1691681682/Projects/unne/img/experienciaUsuarios/mujer.png',
    ...
    last_name:'Lizárraga',
    type:'Asociada Unne',
    comment:'Trabajamos con Unne hace más de 4 años muy conformes sobre todo que están siempre dando valor agregado a sus asociados. ',
  },
  {
    id:4,
    ...
    type:'Asociado Unne',
    comment:'Excelente Gestor Inmobiliario, he visto el crecimiento de mi emprendimiento, vertiginosamente. Espacio donde cuentas además de capacitación constante, solución inmediata a tus solicitudes. Unne es por lejos el mejor gestor inmobiliario de todo Chile. ¡Felicidades!',
  },
  {
    id:5,
    avatar:'https://res.cloudinary.com/dvdb33uyj/image/upload/v1691681682/Projects/unne/img/experienciaUsuarios/mujer.png',
    ...
    type:'Asociada Unne ',
    comment:'Excelente servicio y atención de los ejecutivos de UNNE. Estoy con ellos casi desde sus inicios y no me canso de recomendarlo a mis águila y colegas corredores de propiedades!!',
  },
  {
    id:6,
    avatar:'https://res.cloudinary.com/dvdb33uyj/image/upload/v1691681682/Projects/unne/img/experienciaUsuarios/mujer.png',
    ...
    last_name:'Valiente',
    type:'Asociada Unne ',
    comment:'Mi experiencia con la empresa Unne ha sido excelente, comunicación fluida, capacitaciones permanentes, tanto del uso de la plataforma Unne, como del ámbito de corretaje de propiedades., área legal, comercial, etc.. Gracias Unne.',
  },
  {
    id:7,
    avatar:'https://res.cloudinary.com/dvdb33uyj/image/upload/v1691681678/Projects/unne/img/experienciaUsuarios/hombre.png',
